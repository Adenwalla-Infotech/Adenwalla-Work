...
<head>
  ...
  <title>Manage Coupon | <?php echo _siteconfig('_sitetitle'); ?></title>
  <!-- plugins:css -->
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="">
                    <div class="row">
                      ...
                      <?php } ?>
                      <div class="col-lg-3" style="margin-bottom: 20px;">
                        <select style="height: 40px;" name="type" class="form-control form-control-sm" id="exampleFormControlSelect2">
