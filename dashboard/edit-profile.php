...
<head>
    ...
    <title><?php echo _getsingleuser($_id, '_username'); ?> | <?php echo _siteconfig('_sitetitle'); ?></title>
    <!-- plugins:css -->
                                        ...
                                        <div class="card mb-4 mb-xl-0">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    if($userDp){ ?>
                                                     <img class="img-account-profile rounded-circle mb-2" src="../uploads/profile/<?php echo _getsingleuser($_id, '_userdp'); ?>" alt="" onclick="selectDP()">
                                                    <?php }else{ ?>
                                                        <img class="img-account-profile rounded-circle mb-2" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="" onclick="selectDP()">
                                                    <?php }?>  
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form  >
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        <div class="col-12">
                                                            <label class="small mb-1" for="inputBirthday">User Biography (Bio will appear on the site to other users)</label>
                                                            <textarea name="userbio" class="form-control" cols="10" rows="5" style="padding: 16px; line-height: 1.5;"><?php echo _getsingleuser($_id, '_userbio'); ?></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- Save changes button-->
                                                    <button name="submit" class="btn btn-primary" style="margin-top: 10px;" type="submit"><i class="mdi mdi-content-save"></i>&nbsp;&nbsp;Save changes</button>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
