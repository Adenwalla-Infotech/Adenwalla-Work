...
if(isset($_POST['submit'])){
  ...
  _createmarkup($base,$conversion,$price,$status);
}
...
<head>
  ...
  <title>Currency Markup | <?php echo _siteconfig('_sitetitle'); ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Currency (Currency Markup)</h4>
                  ...
                  <form method="POST" action="">
                    <div class="row">
                      ...
                      <div class="col-lg-2" style="margin-bottom: 20px;">
                        <button type="button" class="btn btn-primary btn-sm font-weight-medium auth-form-btn" style="height:40px" data-bs-toggle="modal" data-bs-target="#exampleModal">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="white" style="width: 15px;" viewBox="0 0 448 512"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg>&nbsp;&nbsp;Add Markup
                        </button>
                      </div>
                    </div>
                  </form>
    ...
    <form action="" method="post">
      <div class="modal-content" style="padding: 10px;">
        <div class="modal-header" style="padding: 0px;margin-bottom: 20px;padding-bottom:10px">
          <h4 class="modal-title fs-5" id="exampleModalLabel">Add Markup (Custom Rate)</h4>
        ...
        <div class="modal-body" style="padding: 0px;">
          <div class="row">
            ...
            <div class="col-lg-6">
              <label for="inputEmail4" class="form-label">Conversion Currency</label>
              <select name="conversion" class="form-control">
                <option selected value="">Select currency</option>
                <option value="USD">America (United States) Dollars – USD</option>
                <option value="AFN">Afghanistan Afghanis – AFN</option>
          ...
          <div class="row" style="margin-top: 20px;">
            <div class="col-lg-6">
              <label for="inputEmail4" class="form-label">Conversion Price</label>
